...
fnt_change_words = dict(
    [("gang", "/"), ("mao", ":"), ("space", " "), ("fu", "-"), ("aa", "A"), ("bb", "B"), ("cc", "C"), ("dd", "D"),
     ("ee", "E"), ("ff", "F"), ("gg", "G"), ("hh", "H"), ("ii", "I"), ("jj", "J"), ("kk", "K"), ("ll", "L"),
     ("mm", "M"), ("nn", "N"), ("oo", "O"), ("pp", "P"), ("qq", "Q"), ("rr", "R"), ("ss", "S"), ("tt", "T"),
     ("uu", "U"), ("vv", "V"), ("ww", "W"), ("xx", "X"), ("yy", "Y"), ("zz", "Z")])
